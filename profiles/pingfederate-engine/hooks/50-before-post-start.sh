...
rm -f /opt/out/instance/server/default/deploy/pf-pingone-mfa-adapter-1.5.2.jar
rm -f /opt/out/instance/server/default/deploy/pf-pingone-mfa-adapter-1.6.1.jar
rm -f /opt/out/instance/server/default/deploy/pf-pingone-mfa-adapter-1.7.jar
rm -f /opt/out/instance/server/default/lib/pf-authn-api-sdk-1.0.0.73.jar
